...
#' Drag the nodes of a network
#'
#' @param p an ggplot/gg/ggraph object, the network diagram used to drag. 
#' @param g an igraph object. Default is the 'ggraph' attribute of p$data.
#'
#' @importFrom igraph tk_coords
#' @importFrom igraph tkplot
#' @importFrom igraph V
#' @return an ggplot/gg/ggraph object
#' @noRd
#' @examples
#' library(igraph)
#' library(ggraph)
